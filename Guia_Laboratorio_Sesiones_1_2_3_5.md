...
Debes ver ambas ramas (`main` y `mi-primera-rama`), y el historial debe mostrar el punto donde se fusionaron. Esto es exactamente lo que vas a usar la próxima sesión, pero trabajando en equipo sobre un repositorio compartido en GitHub.
